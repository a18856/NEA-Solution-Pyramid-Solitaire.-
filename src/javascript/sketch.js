  ...
  //let bottomOfCard = deck.getCardYPositon(0) + (deck.getCardHeight()/2)
   ...
   if((mouseX <= deck.getCardDirections(0,0) && mouseX >= deck.getCardDirections(0,1))&&(mouseY >= deck.getCardDirections(0,3) && mouseY <= deck.getCardDirections(0,4))){//card 27
     ...
     console.log("last 2: " + values.getLastTwoCardsValues());
      ...
      if((deck.getCardCheckValuesIndex(27) == 0) && (deck.getCardCheckValuesIndex(26) == 0)){//checks if the cards below this one are removed. This is done for all cards 20 to 0.
      ...
      if((deck.getCardCheckValuesIndex(26) == 0) && (deck.getCardCheckValuesIndex(25) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(25) == 0) && (deck.getCardCheckValuesIndex(24) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(24) == 0) && (deck.getCardCheckValuesIndex(23) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(23) == 0) && (deck.getCardCheckValuesIndex(22) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(22) == 0) && (deck.getCardCheckValuesIndex(21) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(20) == 0) && (deck.getCardCheckValuesIndex(19) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(19) == 0) && (deck.getCardCheckValuesIndex(18) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(18) == 0) && (deck.getCardCheckValuesIndex(17) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(17) == 0) && (deck.getCardCheckValuesIndex(16) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(16) == 0) && (deck.getCardCheckValuesIndex(15) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(14) == 0) && (deck.getCardCheckValuesIndex(13) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(13) == 0) && (deck.getCardCheckValuesIndex(12) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(12) == 0) && (deck.getCardCheckValuesIndex(11) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(11) == 0) && (deck.getCardCheckValuesIndex(10) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(9) == 0) && (deck.getCardCheckValuesIndex(8) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(8) == 0) && (deck.getCardCheckValuesIndex(7) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(7) == 0) && (deck.getCardCheckValuesIndex(6) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(5) == 0) && (deck.getCardCheckValuesIndex(4) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(4) == 0) && (deck.getCardCheckValuesIndex(3) == 0)){
      ...
      if((deck.getCardCheckValuesIndex(2) == 0) && (deck.getCardCheckValuesIndex(1) == 0)){
